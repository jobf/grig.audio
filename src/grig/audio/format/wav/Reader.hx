...
class Reader
{
    ...
    public function load():Surprise<AudioBuffer<Float32>, tink.core.Error>
    {
    ...
    public function load_interleaved():Surprise<InterleavedAudioBuffer<Float32>, tink.core.Error>
        {
            return Future.async(function(_callback) {
                try {
                    var reader = new format.wav.Reader(input);
